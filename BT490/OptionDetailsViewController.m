...
@implementation OptionDetailsViewController

@synthesize optionToShow;
@synthesize delegate;
...
- (void)viewDidLoad
{
    ...
    if (self.optionToShow != nil) {
        self.title = optionToShow.name;
...
{
    [self.delegate optionDetailsViewControllerDidDone:self];
}
